...
public class StudentService {
    ...
    public boolean addStudent() {
        ...
        try {
            ...
            if (getStudentById(student.getId(), FileService.getAllStudents()) == null) {
                ...
                System.out.println("Please insert student birthdate");
                student.setBirthDate(Menu.inputInConsoleForInt());
                System.out.println("Please insert student gender");
                student.setGender(Menu.inputInConsoleForString().charAt(0));
    ...
    public boolean removeStudentById(int id) {
        ...
        if (isRemoved) {
            ...
            FileService.updateStudents(FileService.getAllStudents());
        }
        return isRemoved;
    }
