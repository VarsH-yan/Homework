...
public class Menu {
    ...
    public void generalMenu(){
        while (!isStopProgram){
            ...
            System.out.println("\033[1;31m" + "*. Exit program");
            System.out.println();
    ...
    private void driverMenu(){
        ...
        while (!isStopDriverMenu){
            ...
            System.out.println("14. Print drivers whos worker id contains this number");
            System.out.println("15. Print drivers whos driver license id contains this number");
            ...
            switch(command) {
                ...
                case "print soonest start driver":
                    ...
                    break;
                case "14":
                case "print drivers whos worker id contains this number":
                    System.out.println("please insert one digit");
                    driverService.printAllDriverInfo(driverService.getDriverWhosWorkerIdContainsThisNumber(inputInConsoleForInt(), FileService.getAllDrivers()));
                    break;
                case "15":
                case "print drivers whos driver license id contains this number":
                    System.out.println("please insert one digit");
                    driverService.printAllDriverInfo(driverService.getDriverWhosDriverLicenceIdContainsThisNumber(inputInConsoleForInt(), FileService.getAllDrivers()));
                    break;
                case "16":
                case "add driver":
                case "add":
        ...
        while (!isStopWorkerMenu){
            ...
            switch(command) {
                ...
                case "print min salary worker":
                    ...
                    break;
                case "12":
                case "print workers whos worker id contains this number":
                    System.out.println("please insert one digit");
                    workerService.printWorkers(workerService.getWorkerWhosWorkerIdContainsThisNumber(inputInConsoleForInt(), FileService.getWorkersAndDrivers()));
                    break;
                case "13":
    ...
    public static void errorMessageForScanner(){
        System.out.println("Your insert data is wrong");
    }
